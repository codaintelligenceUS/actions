...
async function updateTicket(zendeskTicketId, versionTag) {
  let notificationMessage = `
    ...
    Looking forward to your confirmation that we indeed solved your issue. Meanwhile, we will keep this ticket as \`Pending\`, until we hear back from you. If you experience any issues or have any further questions, please reply back to us.
