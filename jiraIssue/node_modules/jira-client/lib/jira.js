...
var JiraApi = /*#__PURE__*/ (function () {
  ...
  function JiraApi(options) {
    ...
    this.strictSSL = options.hasOwnProperty("strictSSL")
      ? options.strictSSL
      : true; // This is so we can fake during unit tests
  ...
  (0, _createClass2["default"])(JiraApi, [
    ...
    },
    {
      ...
      value: function makeUri(_ref) {
        ...
        var tempPath =
          intermediateToUse || "/rest/api/".concat(this.apiVersion);
    ...
    },
    {
      ...
      value: function makeWebhookUri(_ref2) {
        ...
        var intermediateToUse = this.intermediatePath || intermediatePath;
        var tempPath =
          intermediateToUse || "/rest/webhooks/".concat(this.webhookVersion);
    ...
    },
    {
      ...
      value: function makeSprintQueryUri(_ref3) {
        ...
        var tempPath =
          intermediateToUse ||
          "/rest/greenhopper/".concat(this.greenhopperVersion);
    ...
    },
    {
      ...
      value: function makeAgileUri(object) {
        var intermediateToUse =
          this.intermediatePath || object.intermediatePath;
      ...
      value: (function () {
        var _doRequest = (0, _asyncToGenerator2["default"])(
          /*#__PURE__*/ _regenerator["default"].mark(
            function _callee(requestOptions) {
                    ...
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        options = _objectSpread(
                          _objectSpread({}, this.baseOptions),
                          requestOptions,
                        );
                        _context.next = 3;
                ...
                function _callee2$(_context2) {
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        requestHeaders = this.makeRequestHeader(
                          this.makeUri({
                            pathname: "/version/".concat(
                              version,
                      ...
                      case 3:
                        ...
                        return _context2.abrupt(
                          "return",
                          response.issuesUnresolvedCount,
                        );
                    ...
                    switch ((_context3.prev = _context3.next)) {
                      ...
                      case 5:
                        rapidViewResult = response.views.find(function (x) {
                          return (
                            x.name.toLowerCase() === projectName.toLowerCase()
                          );
                        });
      ...
      value: function getBoardIssuesForSprint(boardId, sprintId) {
        ...
        return this.doRequest(
          this.makeRequestHeader(
            this.makeAgileUri({
              pathname: "/board/"
                .concat(boardId, "/sprint/")
                .concat(sprintId, "/issue"),
              query: {
                startAt: startAt,
                maxResults: maxResults,
                jql: jql,
